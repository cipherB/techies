      ...
      <div className="max-w-[1300px] my-[60px] mx-auto px-4 gap-y-14 md:px-14 grid grid-cols-1 md:grid-cols-4 gap-x-10">
        ...
        <div>
          ...
          <button
            ...
            className="bg-palette-primary border-none rounded-[100px] w-full text-sm md:text-xl font-semibold capitalize text-black py-4 flex justify-center items-center gap-x-3"
          >
