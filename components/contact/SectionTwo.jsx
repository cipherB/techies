...
const SectionTwo = () => {
  ...
  return (
    <div className="max-w-[1300px] py-[100px] mobile:px-4 mx-auto md:px-32 ">
      <div className="bg-[#D1E2ED] pt-10 md:pt-[40px] pb-[100px] mobile:px-2 rounded-lg">
        <Tooltip id="my-tooltip" />
        <div className="grid my-10 md:px-14 md:grid-cols-1 gap-x-10">
          {/* Column 1 */}
          <div className="">
            ...
            <p className="text-lg">
              No worries. Your business insights and stats are safe and secure
              with us.
            </p>
          </div>
          <div className="">
            ...
            <span className="flex items-start gap-2 mb-4">
              ...
              >
                <MdInfo className="font-bold text-black" />
              </a>
            </span>
            <textarea
              name="other_info"
            ...
            <h2 className="text-2xl underline md:text-4xl">
